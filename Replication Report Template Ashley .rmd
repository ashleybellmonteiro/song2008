...
### Pretest
Five Prolific participants read the sentence "Switzerland is famous for cuckoo clocks, banks and pocket knives“ which was printed in the font, grey Brush Script MT with a font size of 12. An additional 5 students read the same sentence, but instead in a black Arial font with a font size of 12. Participants were instructed rate the sentence in regards to ease in which they could read the text (1 = very difficult, 7 = very easy). Samples of these sentences are included in figure 1. 

(data not complete yet, therefore no results reported)
